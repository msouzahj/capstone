...
class AccessesControllerTest < ActionController::TestCase
  ...
  test "should create access" do
    assert_difference('Access.count') do
      post :create, access: { events_id: @access.events_id, meets_id: @access.meets_id, seasons_id: @access.seasons_id }
    end
  ...
  test "should update access" do
    patch :update, id: @access, access: { events_id: @access.events_id, meets_id: @access.meets_id, seasons_id: @access.seasons_id }
    assert_redirected_to access_path(assigns(:access))
  end
